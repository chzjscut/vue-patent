  ...
  <div class = 'register'>
    <div class = "main">
      ...
      <template v-if = "activeStep === 0">
        <el-form :model = "formBaseData" ref = "formBase" :rules = "formBaseRules" label-width = "100px"
          ...
          <el-form-item label = "密码：" prop = "password"
            ...
            <el-input v-model = "formBaseData.password" type = "password"
                      placeholder = "6-20位英文（区分大小写）、数字、字符的组合"></el-input>
          </el-form-item>
          <el-form-item label = "确认密码：" prop = "passwordConfirm">
            <el-input v-model = "formBaseData.passwordConfirm" type = "password"
                      placeholder = "请再输入一遍上面的密码"></el-input>
          </el-form-item>
          <el-form-item label = "" prop = "agree"
                        :rules = "[{ required: true, message: '请先同意协议', trigger: 'change' }]">
            <el-checkbox name = "agree" v-model = "formBaseData.agree"></el-checkbox>
            <el-button type = "text">我已阅读并同意条款</el-button>
          </el-form-item>
          <el-form-item label = "">
            <el-button @click = "handleValidatorBaseInfo"
                       type = "primary" style = "width: 80%">下一步
            </el-button>
          </el-form-item>
        </el-form>
      </template>
      <template v-if = "activeStep === 1">
        ...
        <el-form :model = "formBaseData" ref = "formVerification" label-width = "100px" style = "width: 80%">
          ...
          <el-form-item prop = "verifyCode"
            ...
            <el-row>
              <el-col :span = "14">
                <el-input v-model = "formBaseData.verifyCode"
          ...
          <el-form-item label = "">
            <el-button @click = "handleRegister"
                       type = "primary" style = "width: 80%">注册
            </el-button>
          </el-form-item>
        </el-form>
      </template>
      <template v-if = "activeStep === 3">
        <div style = "text-align: center">
          ...
          <el-button @click = "handleGoToHome"
                     type = "primary">{{timeGoToHome}}后跳转到首页
          </el-button>
        </div>
      </template>
    </div>
