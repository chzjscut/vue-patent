        ...
        <div class = "right_form">
          <div class = "right_form_tab">
            <span v-for = "tab in tabs"
                  ...
                  :class = "{'log_tab_active': activeTab === tab.name}">{{tab.title}}</span>
          </div>
          <el-form :model = "formPassword"
            ...
            <el-form-item prop = "account"
              ...
              <el-input v-model = "formPassword.account"
                        prefix-icon = 'el-icon-mobile-phone'
                        placeholder = "请输入手机号码"></el-input>
            </el-form-item>
            <el-form-item prop = "password"
                          :rules = "[{required :true , message: '密码为必填项', trigger: 'blur' }]">
              <el-input v-model = "formPassword.password" type = "password" prefix-icon = 'el-icon-tickets'
                        @keyup.enter.native = "handleLoginClick" placeholder = "请输入密码"></el-input>
            </el-form-item>
          </el-form>
          <el-form v-show = "activeTab === tabs[1].name"
                   :model = "formVerification"
                   ref = "formVerification">
            <el-form-item prop = "account"
                          :rules = "[{required :true , message: '手机号为必填项', trigger: 'blur' },
                          { pattern: /^1[34578]\d{9}$/, message: '手机格式有误', trigger: 'blur' }]">
              <el-input v-model = "formVerification.account"
                        prefix-icon = 'el-icon-mobile-phone'
                        placeholder = '请输入手机号码'></el-input>
            </el-form-item>
            <el-form-item prop = "verifyCode"
              ...
              <el-row>
                <el-col :span = "14">
                  <el-input v-model = "formVerification.verifyCode"
                            prefix-icon = 'el-icon-tickets'
                            placeholder = '请输入验证码'
                            @keyup.enter.native = "handleLoginClick"></el-input>
                </el-col>
          ...
          <el-button @click = "handleLoginClick"
                     ...
                     :style = "{marginBottom: activeTab === tabs[1].name ? '20px' : ''}">登录
          </el-button>

          <p v-show = "activeTab === tabs[0].name"
          ...
          <el-button @click = "handleGoToRegister"
                     style = "width: 100%" type = "primary" plain>立即注册
          </el-button>
          <!--注册结束-->
        </div>
      </div>
