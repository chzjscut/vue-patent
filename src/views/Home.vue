<template>
  <div class = "main">
        ...
        <el-row style = "width: 800px; padding-top: 100px;margin: 0 auto">
          <el-col :span = "20">
            <el-input v-model = "searchKey"
                      ...
                      placeholder = "请输入申请人全称、专利号关键字，如20182021488655"></el-input>
          </el-col>
          <el-col :span = "4">
            <el-button type = "primary" size = "large"
                       style = "width: 100%;border-bottom-left-radius: 0;border-top-left-radius: 0"
                       @click = "handleSearch">查一下
            </el-button>
          </el-col>
        </el-row>
      ...
      <div class = "wp">
        <div class = "s wps cl">
          <template v-for = "(s,i) in serviceList">
            <div class = "sub" @mouseenter = "serviceIndex = i" :key = "i" @mouseleave = "serviceIndex = -1">
              <dl>
                <dt>{{s.title}}</dt>
                <dd class = "m">
                  <img :src = "s.img" width = "80" height = "80" :alt = "s.title">
                </dd>
                <dd class = "des" v-html = "s.desc"></dd>
              </dl>
              <ul class = "on" v-show = "i === serviceIndex">
                <div class = "ul-s">
                  <h6>{{s.layer.title}}</h6>
                  <li v-for = "item in s.layer.descList" v-html = "item" :key = "item"></li>
                </div>
              </ul>
            </div>
          </template>
        ...
        <ul class = "s cl">
          <li v-for = "item in caseList" :key = "item.name">
            <div>
              ...
              <p><span v-html = "item.name"></span></p>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class = "index-customer index-f">
      ...
      <div class = "s wp">
        <div class = "customer-box">
          <div class = "bd">
            <div class = "tempWrap">
              <el-carousel height = "130px" :autoplay = "false" arrow = "never"
                ...
                <el-carousel-item v-for = "(item,i) in customer" :key = "i">
                  <div class = "cl clone">
                    ...
                    <div class = "s-title" v-html = "item.subTitle"></div>
                  </div>
                </el-carousel-item>
              </el-carousel>
            </div>
      ...
      <div class = "wp s">
        <ul class = "cl">
          <li v-for = "(partner,i) in partnerList" :key = "i">
            <a href = "JavaScript:" :style = "{backgroundImage: 'url('+partner+')'}"></a></li>
        </ul>
      </div>
    </div>
    ...
    <div id = "flow" class = "index-process">
      ...
      <div class = "s wp">
        <ul class = "cl">
          <li v-for = "item in processList" class = "no" :key = "item.title">
            <a href = "JavaScript:">
