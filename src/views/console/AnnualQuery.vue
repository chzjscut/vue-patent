<template>
  <div class = 'annual-query'>
    ...
    <div class = "table-filter">
      <el-input placeholder = "请输入专利号" size = "small" v-model = "searchData.zlNo"></el-input>
      <el-input placeholder = "请输入专利权人全称" v-model = "searchData.applyPersonName" size = "small"></el-input>
      <el-input placeholder = "请输入代理机构全称" size = "small" v-model = "searchData.dailijgmc"></el-input>
      <div class = "table-button-group" style = "display: inline-block">
        ...
        <template v-if = "$route.name === 'consoleBatchQuery'">
          <el-upload :action = "batchInsertAction"
            ...
            <el-button class = "filter-box" type = "primary" size = "small"
                       :disabled = "batchImportDisabled">{{batchImportBtnTxt}}
            </el-button>
          </el-upload>
...
<script>
  ...
  import { EXCEL_TEMPLATE , FETCH_HEADERS , UPLOAD_ACTION } from '../../ultils/const'
