<template>
  <div class = 'patent-analysis'>
    ...
    <div id = "overall" ref = "overall"></div>
    <el-row type = "flex" justify = "space-between">
      <el-col>
        <div id = "status" ref = "status"></div>
      </el-col>
      <el-col>
        <div id = "expire" ref = "expire"></div>
      </el-col>
    </el-row>
  </div>
</template>
  ...
  export default {
    ...
    methods : {
      ...
      async fetchOverallData () {
        await this.$api.PATENT_ANALYSIS_OVERALL().then(res => {
      ...
      async fetchStatusData () {
        await this.$api.PATENT_ANALYSIS_STATUS().then(res => {
      ...
      async fetchExpireData () {
        await this.$api.PATENT_ANALYSIS_EXPIRE().then(res => {
