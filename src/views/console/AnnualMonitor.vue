...
<template>
  <div class = 'annual-monitor'>
    ...
    <div class = "table-filter">
      <el-select v-model = "searchFilter.zlType"
                 clearable filterable
                 size = "small"
                 style = "margin-right: 10px;width: 150px"
                 placeholder = "请选择专利类型">
        <el-option v-for = "item in zlTypeOptions"
                   :key = "item.value"
                   :label = "item.key"
                   :value = "item.value">
        </el-option>
      </el-select>
      <el-select v-model = "searchFilter.stateName"
                 clearable filterable
                 size = "small" style = "width: 150px;"
                 placeholder = "请选择年费状态">
        <el-option v-for = "item in stateNameOptions"
                   :key = "item.value"
                   :label = "item.key"
                   :value = "item.value">
        </el-option>
      </el-select>
      <el-date-picker v-model = "searchFilter.applyDateStart"
                      format = "yyyy-MM-dd"
      ...
      <el-date-picker v-model = "searchFilter.applyDateEnd"
                      format = "yyyy-MM-dd"
                      value-format = "yyyy-MM-dd"
                      type = "date" size = "small"
                      placeholder = "请选择申请结束日期">
      </el-date-picker>
      <el-date-picker v-model = "searchFilter.paymentDateStart"
                      format = "yyyy-MM-dd"
                      value-format = "yyyy-MM-dd"
                      type = "date" size = "small"
      ...
      <el-input placeholder = "请输入专利号" size = "small"
                v-model = "searchFilter.zlh"></el-input>
      <el-input placeholder = "请输入申请人全称" size = "small"
                v-model = "searchFilter.applyPersonName"></el-input>
    ...
    <!-- 表格展示 -->
    <table-com :listLoading = listLoading
               :page = "page"
               :size = "size"
               :total = "total"
               :tableData = tableData
               ...
               @multipleSelectChange = "handleMultipleSelectChange"></table-com>
  </div>
</template>
<script>
