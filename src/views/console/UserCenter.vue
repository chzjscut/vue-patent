    ...
    <div class = "uc-form">
      <el-form :model = "formData" ref = "form"
        ...
        <el-form-item label = "QQ：" prop = "qq"
          ...
          <el-input v-model.number = "formData.qq"
                    placeholder = "请填写真实有效QQ，有助于商家联系到你"></el-input>
        </el-form-item>
        <el-form-item label = "邮箱：" prop = "email"
                      :rules = "[{ required: true,type: 'email',
                      message: '请填写真实有效的邮箱，有助于专利监控的通知提醒', trigger: 'blur' }]">
          <el-input v-model = "formData.email"
                    placeholder = "请填写真实有效的邮箱，有助于专利监控的通知提醒"></el-input>
        </el-form-item>
        ...
        <el-form-item>
          <el-button @click = "saveUserInfo" type = "primary" size = "large">保存</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
